...
import com.bala.springboot.ai.ai_rag_textreader.util.RequestParam;
...
public class RagController {
    ...
    @GetMapping("/faq")
    public String faq(@RequestBody RequestParam reqParam) {
    	
    	// Read the vector and get the content of the similar document 
    	List<Document> similarDocument=vectorStore.similaritySearch(SearchRequest.builder()
    			.query(reqParam.message()).topK(reqParam.similaritySize()).build());
    	...
    	promptParams.put("input", reqParam.message());
